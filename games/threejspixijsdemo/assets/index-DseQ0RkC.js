const __vite__fileDeps=["assets/browserAll-CoNAKsq1.js","assets/webworkerAll-Cgk9kZbG.js","assets/colorToUniform-CqGFA_9h.js","assets/CanvasPool-BvGDDOwS.js","assets/batchSamplersUniformGroup-CsHLDTUF.js","assets/WebGPURenderer-CDhsygrj.js","assets/SharedSystems-BGdj3Yfq.js","assets/WebGLRenderer-D2KP_ZYM.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
#define LOW_PRECISION`),e}function J_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Sh?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===od?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Sn&&(e="SHADOWMAP_TYPE_VSM"),e}function Q_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case qi:case ji:e="ENVMAP_TYPE_CUBE";break;case jr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ex(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ji:e="ENVMAP_MODE_REFRACTION";break}return e}function tx(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Eh:e="ENVMAP_BLENDING_MULTIPLY";break;case Id:e="ENVMAP_BLENDING_MIX";break;case Dd:e="ENVMAP_BLENDING_ADD";break}return e}function nx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function ix(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=J_(t),c=Q_(t),h=ex(t),u=tx(t),d=nx(t),f=W_(t),g=X_(r),_=s.createProgram();let p,m,E=t.glslVersion?"#version "+t.glslVersion+`
